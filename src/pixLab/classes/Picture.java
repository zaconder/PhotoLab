...
public class Picture extends SimplePicture 
{
  ...
  public void negate()
  {
	  ...
	  for(int row = 0; row < imageMatrix.length; row++)
	  {
		  ...
		  {  
			 ...
			 Pixel negatePixel = imageMatrix[row][col];
			 int colors = (negatePixel.getRed() + negatePixel.getGreen() + negatePixel.getBlue());
			 if(colors > 0)
			 {
				 negatePixel.setRed(255 - negatePixel.getRed());
				 negatePixel.setBlue(255 - negatePixel.getBlue());
				 negatePixel.setGreen(255 - negatePixel.getGreen());
			 }
		  }
	  }
  }
  ...
  public void sepiaTone()
  {
	  ...
	  for(int row = 0; row < imageMatrix.length; row++)
	  {
		  ...
		  {  
			  ...
			  {
				  sepiaPixel.setRed((int) (sepiaPixel.getRed()* 1.1));
  ...
  Pixel[][] imageMatrix = this.getPixels2D();
	  ...
	  for(int row = 0; row < imageMatrix.length; row++)
	  {
		  for(int col = 0; col < imageMatrix[0].length; col++)
		  {  
			  Pixel grayPixel = imageMatrix[row][col];
			  int averageColor = (grayPixel.getRed() + grayPixel.getBlue() + grayPixel.getGreen())/3;
			  if(averageColor < 255)
			  {
				  grayPixel.setGreen(averageColor);
				  grayPixel.setBlue(averageColor);
				  grayPixel.setRed(averageColor);
			  }
